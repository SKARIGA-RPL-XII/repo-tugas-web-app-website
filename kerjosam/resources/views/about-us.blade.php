...
<body class="bg-gray-50 text-gray-800 antialiased overflow-x-hidden">
    ...
    <img src="/images/about/Overlay6.png" class="absolute inset-0 w-full h-full object-cover" />
    <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-red-600/40 to-transparent"></div>

    <div
        class="relative z-10 w-full px-4 sm:px-6 md:px-12 py-8 md:py-10
...
<footer class="bg-white border-t">
    <div class="w-full px-4 md:px-8 lg:px-16 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <img src="/images/LogoWeb.png" class="w-20 md:w-32 mb-4">
